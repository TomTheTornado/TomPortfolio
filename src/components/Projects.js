    ...
    <div>
      <Container>
        ...
        <Row className="d-flex align-items-center justify-content-center galleryRow">
          ...
          <a href="" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick" src="./projects/BFB.JPG"/></a>
          </Col>
        ...
        <Row className="d-flex align-items-center justify-content-center galleryRow">
          ...
          <Col className="justify-content-center"><a href="https://adventuresconquest.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img className="w-100 galleryImgR imgClick" src="./projects/spriteCreator.JPG"/></a></Col>
        </Row>

        <Row className="d-flex align-items-center justify-content-center galleryRow">
          <Col className="justify-content-center"><a href="https://adventuresconquest.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick" src="./projects/adventureConquest.jpg"/></a></Col>
          <Col className="projectOrange">
        ...
        <Row className="d-flex align-items-center justify-content-center galleryRow">
          ...
          <Col className="justify-content-center"><a href="https://devpost.com/software/photocenter-he1ajs" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick" src="./projects/photocenter.jpg"/></a></Col>
        </Row>

        <Row className="d-flex align-items-center justify-content-center galleryRow">
          <Col className="justify-content-center">
            <a href="https://github.com/TomTheTornado/COMS327/tree/master/Sudoku" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick imgBorder" src="./projects/sudoku.jpg"/></a>
          </Col>
          <Col className="projectOrange">
        ...
        <Row className="d-flex align-items-center justify-content-center galleryRow">
          ...
          <Col className="justify-content-center">
            <a target="_blank" href="https://github.com/TomTheTornado/COMS327/tree/master/Sudoku" rel="noopener noreferrer"><img alt="Reversi Console" className="w-100 imgClick" src="./projects/reversiConsole.jpg"/></a>
          </Col>
        </Row>

        <Row className="d-flex align-items-center justify-content-center galleryRow">
          <Col className="justify-content-center"><a href="https://devpost.com/software/photocenter-he1ajs" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick imgBorder" src="./projects/roguelikeDungeon.jpg"/></a></Col>
          <Col className="projectOrange">
        ...
        <Row className="d-flex align-items-center justify-content-center galleryRow">
          ...
          <Col className="justify-content-center"><a href="https://devpost.com/software/photocenter-he1ajs" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick" src="./projects/batSignal.jpg"/></a></Col>
        </Row>

        <Row className="d-flex align-items-center justify-content-center galleryRow">
          <Col className="justify-content-center"><a href="https://devpost.com/software/photocenter-he1ajs" target="_blank" rel="noopener noreferrer"><img className="w-100 imgClick" src="./projects/spaceRace.jpg"/></a></Col>
          <Col className="projectOrange">
